...
class Product:
    ...
    def __str__(self):
        return self._name + " (" + str(self._upc) + ") "
...
class ElectronicProduct(Product):
    ...
    def __init__(self, upc, name, size):
        super().__init__(upc,name)
        self.__size = size # size in megabytes

    def get_price(self):
        """Returns price as 10 times size in MB"""
        return 10*self.__size
...
products = { 'book' : Product(232131233, 'Book'),
             ...
             'ebook': ElectronicProduct(234234234,'eBook', 15)}
